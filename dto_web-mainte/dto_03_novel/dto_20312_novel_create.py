...
class DtoNovelCreateForm(forms.Form):
    ...
    novel_title_code = forms.CharField(
        label='小説タイトルコード',
        required=True,
        error_messages={'required': ValidationUtil.E0000001.format('小説タイトルコード')}
    )
    novel_title_name = forms.CharField(
        label='小説タイトル名',
        max_length=100,
        required=True,
        error_messages={'required': ValidationUtil.E0000001.format('小説タイトル名'),
                        'max_length': ValidationUtil.E0000002.format('小説タイトル名','100')},
    )
