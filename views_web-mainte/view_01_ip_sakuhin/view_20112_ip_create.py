...
from admin_app.service.service_01_ip_sakuhin.service_20112_ip_create import IpCreateService

class IpCreateView(MainView):

    #サービスクラス
    ipCreateService = IpCreateService()
    #テンプレート
    template_name = 'admin_app/01_ip_sakuhin/20112_ip_create.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        #サービスの実行
        dto = self.ipCreateService.initialize()
    ...
    def post(self, request):
        ...
        context ={}
        #サービスの実行
        dto = self.ipCreateService.createIpData(request)
        # javascriptデータ連携用
        context['object_to_javascript'] = json.dumps(dto, default=self.json_serial)
        #組み込みタグ用
        context['object_to_html'] = dto
        ...
        if 'save_more_one' in request.POST:
            return redirect('admin_app:20112_ip_create')
