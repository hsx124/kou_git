...
# from admin_app.service.service_08_media_report/service_20811_media_report_list import MediaReportListService


class MediaReportListView(ListView):

    #サービスクラス

    #テンプレート
    template_name = 'admin_app/08_media_report/20811_media_report_list.html'
