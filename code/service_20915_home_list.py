...
class HomeListService(ServiceList):
    ...
    '''初期描画'''
    def initialize(self,tableName,tableName2):
        # 領域用DTOを画面DTOに詰める
        # 更新履歴
    ...
    def getnoticetable(self, tableName, tableName2):
        ...
        # 更新履歴
        notice_table = self.mapping(DtoList.DtoBannerTable, self.dao_t_update_history.selectChangeForHomeListByTableName(tableName,tableName2))
