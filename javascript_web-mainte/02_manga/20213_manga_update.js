var MangaUpdateController = function() {};
MangaUpdateController.prototype = new AbstractController();

/**
 * メニュー選択処理
 */
MangaUpdateController.prototype.selectedMenu = function() {
    return '.manga_list';
};
 ...
 * イベント登録処理
 */
MangaUpdateController.prototype.bindEvent = function() {
    var self = this;
...
MangaUpdateController.prototype.openModalEvent = function() {
    var self = this;
...
MangaUpdateController.prototype.deleteBtnEvent = function(){
    // 掲載媒体データ削除ボタン
...
// モーダル検索
MangaUpdateController.prototype.searchModal = function(param, callback, modal) {
    // ajaxでデータ取得
...
// モーダル(掲載媒体)
MangaUpdateController.prototype.openMediaModal = function() {
    var self = this;
    $('#errorMsg').hide();
...
// 掲載媒体マスタ検索（初期化）
MangaUpdateController.prototype.searchMediaInit = function(modal) {
    var self = this;
    var param = {
        'process_code' : 'media',
        'keyword' : ''
...
// 掲載媒体マスタ検索
MangaUpdateController.prototype.searchMedia = function(modal) {
    var self = this;
    var param = {
        'process_code' : 'media',
...
// 掲載媒体マスタ検索結果を描画する
MangaUpdateController.prototype.drawMediaList = function(mediaData,modal) {
    $('.media-btn-list').empty();
...
// モーダル(出版社)
MangaUpdateController.prototype.openPublisherModal = function() {
    var self = this;
    $('#errorMsg').hide();
...
// 出版社マスタ検索（初期化）
MangaUpdateController.prototype.searchPublisherInit = function(modal) {
    var self = this;
    var param = {
...
// 出版社マスタ検索
MangaUpdateController.prototype.searchPublisher = function(modal) {
    var self = this;
    var param = {
        'process_code' : 'publisher',
...
// 出版社マスタ検索結果を描画する
MangaUpdateController.prototype.drawPublisherList = function(publisherData) {
    $('.publisher-btn-list').empty();
...
// モーダル検索(スタッフ)
MangaUpdateController.prototype.searchModalStaff = function(param, callback, modal, select) {
    // ajaxでデータ取得
    AjaxUtil.get('/admin_app/manga_create/', param).then(function(xhr,status) {
        if(status == 'success'){
            var result = JSON.parse(xhr.responseText);
...
// モーダル(スタッフ役割)
MangaUpdateController.prototype.openStaffRoleModal = function(select) {
    var self = this;
    $('#errorMsg').hide();
...
// スタッフマスタ検索（初期化）
MangaUpdateController.prototype.searchStaffRoleInit = function(modal,select) {
    var self = this;
    var param = {
...
// スタッフ役割マスタ検索
MangaUpdateController.prototype.searchStaffRole = function(modal,select) {
    var self = this;
    var param = {
        'process_code' : 'staff_role',
...
// スタッフ役割マスタ検索結果を描画する
MangaUpdateController.prototype.drawStaffRoleList = function(staffRoleData,modal,select) {
    $('.staff-role-btn-list').empty();
...
// モーダル(スタッフ)
MangaUpdateController.prototype.openStaffModal = function(select) {
    var self = this;
    $('#errorMsg').hide();
...
// スタッフマスタ検索（初期化）
MangaUpdateController.prototype.searchStaffInit = function(modal,select) {
    var self = this;
    var param = {
        'process_code' : 'staff',
        'keyword' : ''
...
// スタッフマスタ検索
MangaUpdateController.prototype.searchStaff = function(modal,select) {
    var self = this;
    var param = {
        'process_code' : 'staff',
...
// スタッフマスタ検索結果を描画する
MangaUpdateController.prototype.drawStaffList = function(staffData,modal,select) {
    $('.staff-btn-list').empty();
...
$(function() {
    var controller = new MangaUpdateController();
    controller.init();
});
