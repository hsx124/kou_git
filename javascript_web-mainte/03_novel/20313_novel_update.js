var NovelUpdateController = function() {};
NovelUpdateController.prototype = new AbstractController();

/**
 * メニュー選択処理
 */
NovelUpdateController.prototype.selectedMenu = function() {
    return '.novel_list';
};
 ...
 * イベント登録処理
 */
NovelUpdateController.prototype.bindEvent = function() {
    var self = this;
    ...
    $('.back-button').on('click', function() {
        window.location.href = '/admin_app/novel_list/';
    });

    return $.Deferred().resolve().promise();
};

NovelUpdateController.prototype.openModalEvent = function() {
    var self = this;
...
NovelUpdateController.prototype.deleteBtnEvent = function(){
    // 掲載媒体データ削除ボタン
    $('.media-delete-button').on('click',function(){
        $('#media-code').val('');
        $('#media-name').val('');
        $('#media-name').text('掲載媒体を選択');
        // セレクトボックスを再読み込みする
...
// モーダル検索
NovelUpdateController.prototype.searchModal = function(param, callback, modal) {
    // ajaxでデータ取得
    AjaxUtil.get('/admin_app/novel_create/', param).then(function(xhr,status) {
        if(status == 'success'){
...
// モーダル(掲載媒体)
NovelUpdateController.prototype.openMediaModal = function() {
    var self = this;
    $('#errorMsg').hide();
...
// 掲載媒体マスタ検索（初期化）
NovelUpdateController.prototype.searchMediaInit = function(modal) {
    var self = this;
    var param = {
        'process_code' : 'media',
        'keyword' : ''
...
// 掲載媒体マスタ検索
NovelUpdateController.prototype.searchMedia = function(modal) {
    var self = this;
    var param = {
        'process_code' : 'media',
...
// 掲載媒体マスタ検索結果を描画する
NovelUpdateController.prototype.drawMediaList = function(mediaData,modal) {
    $('.media-btn-list').empty();
...
// モーダル(出版社)
NovelUpdateController.prototype.openPublisherModal = function() {
    var self = this;
    $('#errorMsg').hide();
...
// 出版社マスタ検索（初期化）
NovelUpdateController.prototype.searchPublisherInit = function(modal) {
    var self = this;
    var param = {
...
// 出版社マスタ検索
NovelUpdateController.prototype.searchPublisher = function(modal) {
    var self = this;
    var param = {
        'process_code' : 'publisher',
...
// 出版社マスタ検索結果を描画する
NovelUpdateController.prototype.drawPublisherList = function(publisherData) {
    $('.publisher-btn-list').empty();
...
// モーダル検索(スタッフ)
NovelUpdateController.prototype.searchModalStaff = function(param, callback, modal, select) {
    // ajaxでデータ取得
    AjaxUtil.get('/admin_app/novel_create/', param).then(function(xhr,status) {
        if(status == 'success'){
            var result = JSON.parse(xhr.responseText);
...
// モーダル(スタッフ役割)
NovelUpdateController.prototype.openStaffRoleModal = function(select) {
    var self = this;
    $('#errorMsg').hide();
...
// スタッフマスタ検索（初期化）
NovelUpdateController.prototype.searchStaffRoleInit = function(modal,select) {
    var self = this;
    var param = {
...
// スタッフ役割マスタ検索
NovelUpdateController.prototype.searchStaffRole = function(modal,select) {
    var self = this;
    var param = {
        'process_code' : 'staff_role',
...
// スタッフ役割マスタ検索結果を描画する
NovelUpdateController.prototype.drawStaffRoleList = function(staffRoleData,modal,select) {
    $('.staff-role-btn-list').empty();
...
// モーダル(スタッフ)
NovelUpdateController.prototype.openStaffModal = function(select) {
    var self = this;
    $('#errorMsg').hide();
...
// スタッフマスタ検索（初期化）
NovelUpdateController.prototype.searchStaffInit = function(modal,select) {
    var self = this;
    var param = {
        'process_code' : 'staff',
        'keyword' : ''
...
// スタッフマスタ検索
NovelUpdateController.prototype.searchStaff = function(modal,select) {
    var self = this;
    var param = {
        'process_code' : 'staff',
...
// スタッフマスタ検索結果を描画する
NovelUpdateController.prototype.drawStaffList = function(staffData,modal,select) {
    $('.staff-btn-list').empty();
...
$(function() {
    var controller = new NovelUpdateController();
    controller.init();
});
