var NovelCreateController = function() {
};
NovelCreateController.prototype = new AbstractController();

/**
 * メニュー選択処理
 */
NovelCreateController.prototype.selectedMenu = function() {
    return '.novel-list';
};
 ...
 * イベント登録処理
 */
NovelCreateController.prototype.bindEvent = function() {
    var self = this;
...
NovelCreateController.prototype.openModalEvent = function() {
    var self = this;
...
NovelCreateController.prototype.deleteBtnEvent = function(){
    // 掲載媒体データ削除ボタン
...
// モーダル検索
NovelCreateController.prototype.searchModal = function(param, callback, modal) {
    // ajaxでデータ取得
...
// モーダル(掲載媒体)
NovelCreateController.prototype.openMediaModal = function() {
    var self = this;
    $('#errorMsg').hide();
...
// 掲載媒体マスタ検索（初期化）
NovelCreateController.prototype.searchMediaInit = function(modal) {
    var self = this;
    var param = {
        'process_code' : 'media',
        'keyword' : ''
...
// 掲載媒体マスタ検索
NovelCreateController.prototype.searchMedia = function(modal) {
    var self = this;
    var param = {
        'process_code' : 'media',
...
// 掲載媒体マスタ検索結果を描画する
NovelCreateController.prototype.drawMediaList = function(mediaData,modal) {
    $('.media-btn-list').empty();
...
// モーダル(出版社)
NovelCreateController.prototype.openPublisherModal = function() {
    var self = this;
    $('#errorMsg').hide();
...
// 出版社マスタ検索（初期化）
NovelCreateController.prototype.searchPublisherInit = function(modal) {
    var self = this;
    var param = {
...
// 出版社マスタ検索
NovelCreateController.prototype.searchPublisher = function(modal) {
    var self = this;
    var param = {
        'process_code' : 'publisher',
...
// 出版社マスタ検索結果を描画する
NovelCreateController.prototype.drawPublisherList = function(publisherData) {
    $('.publisher-btn-list').empty();
...
// モーダル検索(スタッフ)
NovelCreateController.prototype.searchModalStaff = function(param, callback, modal, select) {
    // ajaxでデータ取得
    AjaxUtil.get('/admin_app/novel_create/', param).then(function(xhr,status) {
        if(status == 'success'){
            var result = JSON.parse(xhr.responseText);
...
// モーダル(スタッフ役割)
NovelCreateController.prototype.openStaffRoleModal = function(select) {
    var self = this;
    $('#errorMsg').hide();
...
// スタッフマスタ検索（初期化）
NovelCreateController.prototype.searchStaffRoleInit = function(modal,select) {
    var self = this;
    var param = {
...
// スタッフ役割マスタ検索
NovelCreateController.prototype.searchStaffRole = function(modal,select) {
    var self = this;
    var param = {
        'process_code' : 'staff_role',
...
// スタッフ役割マスタ検索結果を描画する
NovelCreateController.prototype.drawStaffRoleList = function(staffRoleData,modal,select) {
    $('.staff-role-btn-list').empty();
...
// モーダル(スタッフ)
NovelCreateController.prototype.openStaffModal = function(select) {
    var self = this;
    $('#errorMsg').hide();
...
// スタッフマスタ検索（初期化）
NovelCreateController.prototype.searchStaffInit = function(modal,select) {
    var self = this;
    var param = {
        'process_code' : 'staff',
        'keyword' : ''
...
// スタッフマスタ検索
NovelCreateController.prototype.searchStaff = function(modal,select) {
    var self = this;
    var param = {
        'process_code' : 'staff',
...
// スタッフマスタ検索結果を描画する
NovelCreateController.prototype.drawStaffList = function(staffData,modal,select) {
    $('.staff-btn-list').empty();
...
$(function() {
    var controller = new NovelCreateController();
    controller.init();
});
